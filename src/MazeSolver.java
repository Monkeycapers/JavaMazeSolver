                ...
                for (char d: directions) {
                    ...
                    //if (d != robot.direction) {
                        ...
                        if (mazeTile == null) {
                            ...
                            //System.out.println("Check tile: " + checkTile(mazeTile, d));
...
//                    }
                    //System.out.println("Check tile: " + checkTile(mazeTile, robot.direction));
    ...
    private boolean notRedundant(MazeTile mazeTile) {
        ...
        assert (!isNotRedundant) : "A Redundant tile";
        System.out.println("NOT REDUNDANT: " + isNotRedundant);
